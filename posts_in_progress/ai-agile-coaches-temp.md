...
באותו המחקר בדקו חוקרי McKinsey את הגורמים שכן מובילים אירגונים לצלוח את המחסומים וגילו שהחברות המצליחות בטרנספורמציה דיגיטלית מיישמות את רעיון ה - **"multidisciplinary agile teams"** כחלק מהמודל התפעולי שלהן.
צוותים אג'יליים עצמאיים המכילים ככל האפשר את כלל היכולות הנדרשות לדליברי מהיר ואפקטיבי נטול מחסומים.

זה לא צירוף מקרים שזהו אחד מגורמי ההצלחה החשובים - כי אג'יליות אירגונית בעצם מאפשרת:
- **לעמוד בקצב** המטורף של חידושי AI.
- **לצמצם למינימום ביזבוז מיותר של אנרגיה** ולדלבר תוצרים בעלי ערך.
- **לתת למוצרים להתפתח** בצורה רלוונטית ללקוחות שמגבירה ערך מפעם לפעם.
- **להתמודד עם אי-ודאות** כעובדת חיים, לא כמכשול.

## מאמני האג'ייל: האנבלרים של השינוי

מאמני אג'ייל מנוסים עומדים בצומת קריטית.
הם יכולים להוביל את המהלכים ולגייס את האג'יליות הטבעית שהם מובילים כבר שנים כדי לסייע לאירגון לזוז באלגנטיות עם השינוי, ובו בזמן הם יכולים לפספס את המומנטום ולא לשים לב לשינוי עצמו.

### אלו האתגרים שעלולים לעמוד בפני המאמני האג'ייל:

1. **חוסר מוכנות טכנולוגית** - לא כולם אנשים טכנולוגיים ועוד יותר קשה להבין את טכנולוגיות ה-AI
2. **התנגדות לשינוי** - דווקא המנוסים יכולים למצוא את עצמם נצמדים לשיטות שעבדו להם בעבר ולא בטוח שימשיכו לעבוד
3. **קושי בהבנת הסקייל** - הקצב הנוכחי שונה מכל מה שחווינו בעבר
